...
- **Improved Global Profile Tooltip**: Enhanced the "Global Profile" node's tooltip in the Sidebar Tree View to display detailed global Git settings (Name, Email, GPG Signing, and GPG Key).
